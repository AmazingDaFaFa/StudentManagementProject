...
public class UpdateStudentInfo {
	 ...
	 */
	public static void main(Student student,AdminDAO adminDAO) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UpdateStudentInfo window = new UpdateStudentInfo(student,adminDAO);
	 ...
	 */
	public UpdateStudentInfo(Student student,AdminDAO adminDAO) {
	...
	private void initialize() {
		...
		if(radioButton_1.isSelected()){
		     this.sex= radioButton_1.getText();
		}
	...
	public String[] getStudentInfo() {
		String studentInfo[]={String.valueOf(this.id),this.name,this.sex,this.grade,this.major,this.hometown,this.tel,this.email};
		return studentInfo;
	}
}
