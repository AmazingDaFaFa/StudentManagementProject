...
public class TeacherDAO extends BaseDAO{
	...
	public boolean addGrade(Teacher teacher, int cid, Student student, String score, String cname) {
		...
		try {
			...
			if(rs.next()) {	//如果该学生的成绩已经存在，则无法再添加成绩
				//add ERROR to .Log
			...
			System.out.println(456+cid);
			System.out.println(789+teacher.getID());
			System.out.println(rs.toString(rs));
			if(rs == null) {
				//add ERROR to .Log
				String logContent = "Teacher: \'" + teacher.getName() + "\' ADD RECORD ERROR to TABLE:StudentCourse";
				myLog.addLog(MyLog.TYPE.ERROR, logContent);
...
//			sql = "INSERT INTO studentmanagementdemo.StudentCourse (SID,CID,Cname,Cscore) VALUES ("+student.getID()+","+cid+","+rs.getString("Cname")+","+score+")";
